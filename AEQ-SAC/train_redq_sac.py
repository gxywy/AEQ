...
import time
import sys
from algos.redq_sac import REDQSACAgent
...
if __name__ == '__main__':
    ...
    redq_sac(args.env, seed=args.seed, epochs=args.epochs,
             ...
             mylogger=mylogger,
             utd_ratio=args.utd_ratio, evaluate_bias=args.log_q, reseed_each_epoch=args.ep_seed, policy_update_delay=args.policy_delay)
